...
class TrianingPage extends StatefulWidget {
  @override
  _TrianingPageState createState() => _TrianingPageState();
}

class _TrianingPageState extends State<TrianingPage>
    with SingleTickerProviderStateMixin {
  Animation<double> scaleAnimation;
  AnimationController controller;
  DrawerService _drawerService = new DrawerService();
  List<Training> _trining = List<Training>();
  String dateOrg = "";
  void _populateNewsArticles() {
    _drawerService.getUserTrianing().then((newsLeave) => {
